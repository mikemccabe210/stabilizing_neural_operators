...
c = idxes[fld]
config1 = 'pretrained_two_step_afno_20ch_bs_64_lr1em4_blk_8_patch_8_cosine_sched_inf/0'
...
lns = ["o-"] # line colors for plots apart from ifs
colors = ["r"]
nms = [""] # "_coarse" to use the coarse acc vals from inference.py

labels = ["FourCastNet p=8"]
...
fig.tight_layout()
file_nm = os.path.join(*[basepath, "fourcastnet_accrmse_"+fld+".pdf"])
